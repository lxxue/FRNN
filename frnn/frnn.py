...
_GRID = namedtuple("GRID", "sorted_points1 sorted_points2 pc2_grid_off sorted_points1_idxs sorted_points2_idxs grid_params")
...
def frnn_grid_points(
  ...
  if grid is None:
    ...
    idxs, dists = _C.find_nbrs_cuda(
      grid[0],        # sorted_points1
      grid[1],        # sorted_points2
      lengths1,
      lengths2,
      grid[2],        # pc2_grid_off
      grid[3],        # sorted_points1_idxs
      grid[4],        # sorted_points2_idxs
      grid[5],        # grid_params_cuda
      K,
      r
    )
    # use cached grid
  ...
  if return_grid:
    if grid is not None:
      ...
      return idxs, dists, nn, \
        _GRID(
          sorted_points1=sorted_points1, # (N, P , 3) 
          sorted_points2=sorted_points2, # (N, P , 3) 
          pc2_grid_off=pc2_grid_off,  # (N, G)
          sorted_points1_idxs=sorted_points1_idxs,  # (N, P)
